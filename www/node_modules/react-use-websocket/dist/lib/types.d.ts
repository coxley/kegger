...
export declare type SendJsonMessage = (jsonMessage: JsonValue, keep?: boolean) => void;
...
export declare type WebSocketHook<T = JsonValue, P = WebSocketEventMap['message'] | null> = {
...
export declare type JsonObject = {
    [Key in string]?: JsonValue | JsonPrimitive;
};
/**
...
@category JSON
*/
export declare type JsonValue = JsonObject | JsonArray;
